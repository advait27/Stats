# stl_Kokru_Dharmadhikari_Sinha_eda.R
#
# MIS41120 Statistical Learning — Practical Assignment
# Stage 1: exploratory data analysis of the UCI "Default of Credit Card Clients"
# data. The point here is just to look at the data before we model it: shape,
# class balance, predictor distributions, where the signal is (repayment
# status), collinearity among the bill amounts, and the odd category codes.
# We don't clean or recode anything yet — that's Stage 2. This only flags what
# needs fixing.
#
# Relative paths throughout, seed is set, figures land in figures/.
# Run from the project root. In RStudio: Session > Set Working Directory >
# To Source File Location, then Source.


# --- Setup: seed, packages, output folder ---
